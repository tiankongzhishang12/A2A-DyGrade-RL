...
**创建日期**：2026-07-04
**最后修订**：2026-08-17
**状态**：V1.7 AutoDL 服务器接管与真实 Ministral 3 Pilot 已进入远程执行阶段；V1.6 本地准备 P1–P8、Dataset Semantic V2、internal audit、AutoDL 仓库同步、14B BF16 下载/完整性校验、冻结 5 Item 的 10 文件传输、远程 Codex CLI、进程级 Mihomo、双账号共享会话切换与远程 bootstrap Smoke 均已完成；GPU 当前关闭。本机 Codex 官方 SSH Connection UI 的只读 Smoke、14B 下载产物回传、Token/预算冻结、推理环境、14B 真实 Smoke、3B/8B、真实 5 Item 和 30 Item 尚未完成。
